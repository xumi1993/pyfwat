 ...
 !
 ! number of ES nodes =    10.00000    
 ! percentage of total 640 ES nodes =    1.562500      %
 ! total memory available on these ES nodes (Gb) =    160.0000    
 !
 ! min vector length =           25
 ! min critical vector length =           75
 !
 ! master process: total points per AB slice =        39585
 ...
 !
 ! time step =   5.000000000000000E-002
 !
 ! attenuation uses:
 !  NSPEC_ATTENUATION =            1
 ! 
 ...
 ! ----------------------------------------------
 !
 ! size of arrays for the largest slice =    4.48094177246094       MB
 !                                      =   4.375919699668884E-003  GB
 !
